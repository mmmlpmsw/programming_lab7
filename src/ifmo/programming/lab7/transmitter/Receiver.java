...
public class Receiver {
    ...
    private void processIncomingPacket(DatagramPacket packet) {
        ...
        if (!collectors.containsKey(requestID))
            collectors.put(requestID, new PieceCollector(requestID, packet.getAddress()));
    ...
    private class PieceCollector {
        ...
        PieceCollector(int requestID, InetAddress address) {
        ...
        private void collected() {
            ...
            if (listener != null)
                listener.received(requestID, result, address);
        }
